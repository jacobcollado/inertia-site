...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.resend.com https://api.stripe.com https://*.myshopify.com https://us.posthog.com https://app.cal.com https://cal.com",
      "script-src-elem 'self' 'unsafe-inline' https://js.stripe.com https://app.cal.com",
