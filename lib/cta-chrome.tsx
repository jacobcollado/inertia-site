...
export const CTA_HEADER_PILL_CLASS =
  "relative inline-flex items-center overflow-hidden rounded-[6px] px-4 py-1 sm:px-4 sm:py-1 text-[14px] sm:text-[15px] font-normal tracking-tight leading-none " +
