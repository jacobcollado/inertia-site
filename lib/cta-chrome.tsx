...
export const CTA_PILL_CLASS =
  "relative inline-flex items-center gap-2 overflow-hidden rounded-full px-4 py-1 sm:px-5 sm:py-1 text-[15px] sm:text-[16px] font-normal tracking-tight leading-none h-9 sm:h-10";
...
export function CtaWell({ children }: { children: React.ReactNode }) {
  return (
    <span className={CTA_WELL_CLASS} style={{ background: CTA_WELL_BG, boxShadow: CTA_WELL_SHADOW }}>
      <CtaWellSpecular />
      {children}
    </span>
  );
